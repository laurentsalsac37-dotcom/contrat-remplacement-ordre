...
export const contractSchema = z.object({
  ...
  remplaceSuspendActivite: z.literal(true),
  remplacantUtiliseSaCps: z.literal(true),
  jamaisCpsDuRemplace: z.literal(true),
  rcpValide: z.literal(true),
  autorisationValide: z.literal(true),
  pasPlusDeuxRemplacements: z.literal(true),
  transmissionOrdre: z.literal(true),
  aucuneContreLettre: z.literal(true),
});
